...
const User = {
  ...
  createUser: (data) => requests.post('user/createUser', data),
  updateUser: (data) => requests.put('user/updateUser', data),
  deleteUser: (userId) => requests.del('user/deleteUser?userId=' + userId),
  getUserInformationById: (userId) => requests.get('user/getUserInformationById?UserId=' + userId),
